...
package com.ksharp.android.turtlebot;
...
public class DemoActivity extends Activity {
    ...
    public void toggleLED(View view) {
        mDumpTextView.append("Sending Toggle LED\n");
        
        if (mSerialDevice != null) {
            String srcStr = "t";
            try {
                mSerialDevice.write(srcStr.getBytes("UTF-8"), 100);
            } catch (IOException e) {
                mDumpTextView.append("IOException Occurred\n");
            }
        }
    }
